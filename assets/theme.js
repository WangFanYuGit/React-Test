...
(function($){
  ...
  theme.QtySelector = (function() {
    var classes = {
      ...
      dele:".delete_item-by_add_to_cart"
    };
    ...
    function QtySelector($el, options) {
      ...
      this.$dele = $el.find(classes.dele);
    ...
    CartDrawer.prototype = $.extend({}, CartDrawer.prototype, {
      ...
      updateCartNotification: function(evt, cart) {
        if (cart.items.length > 0) {
          $(selectors.cartBubble).addClass('cart-link__bubble--visible').html(cart.item.count);
